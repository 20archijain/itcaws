...
class ProcessMdoData
{
    ...
    final public function processMdoData()
    {
        ...
        // $sQuery = "SELECT id, mdo_id, teams, is_type FROM tblmdo_access WHERE dstatus = 0 AND is_type NOT IN (2,5) AND mdo_id IN (22873) AND is_previous_day_updated = 0 LIMIT 50";
