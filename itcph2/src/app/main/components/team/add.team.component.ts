...
export class AddTeamComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  teamsConfig: InputConfig[] = [
    {
      controlName: 'dsName', errorMessages: COMMON_VALIDATORS.messages.name('Surveyor Name', CUSTOM_VALIDATION_LENGTH.TEAM_NAME_MAXLENGTH),
    ...
    {
      controlName: 'dsPhone', errorMessages: COMMON_VALIDATORS.messages.mobile('Surveyor Phone'),
      label: 'app.team.add.dsNumber', type: CONTROL_CONFIG.INPUT_BOX,
