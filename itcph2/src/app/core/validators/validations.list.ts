...
import {
  ...
  NUMBER_REGEX, PASSWORD_REGEX, POSITIVE_FLOAT_NUMBER_REGEX, STOCK_NUMBER_MAX_3_REGEX, STOCK_NUMBER_REGEX, STRONG_PASSWORD_REGEX, USERNAME_REGEX,
} from './regex';
import {
...
export const COMMON_VALIDATORS = {
  ...
  validators: {
    ...
    zeroAndFloatQtyMax3Stock: [
      REGEX_VALIDATOR(STOCK_NUMBER_MAX_3_REGEX),
      Validators.min(VALIDATION_LENGTH.MINVALUE - 1),
      Validators.maxLength(VALIDATION_LENGTH.QTY_MAXLENGTH + 3),
    ],
