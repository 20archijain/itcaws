...
export const environment = {
  ...
  viewBreezeDashboardDataUrl: baseUrl + 'viewBreezeDashboardData.json',
  viewDashboardDataUrl: baseUrl + 'viewDashboardData.json',
  viewNpsrDashboardDataUrl: baseUrl + 'viewNpsrDashboardData.json',
  viewNpsrDashboard2DataUrl: baseUrl + 'viewNpsrDashboard2Data.json',
  viewProductiveDashboardDataUrl: baseUrl + 'viewProductiveDashboardData.json',
