...
$storeOptions->storeDBWiseOptions($GLOBALS['WONDER_DB'], $teamCondition);
$storeOptions->storeDBWiseOptions($GLOBALS['ZX_DB'], $teamCondition);
$storeOptions->storeDBWiseOptions($GLOBALS['NOVICEMARCOM_DB'], $teamCondition);
$storeOptions->storeDBWiseOptions($GLOBALS['IMPACT_DB'], $teamCondition);
$dbConn->Close();
