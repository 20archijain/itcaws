...
$maxCallsAllowedPerDay = 2;

// DB params
$dbName = $ITCNEW_DB;
$missCallTable = "tblcloudring_live_pushkar";
$missCallNumber = "8130667888";
...
if ($sMobile) {
    ...
    if ($iTotal < $maxCallsAllowedPerDay) {
        // Generate OTP
        $getUniqueCode = "";
        $message = "पुष्कर में Sunfeast YiPPee! परिवार का हिस्सा बनने के लिए आपका धन्यवाद - APPILARY";
