...
// DB params
$dbName = $ITCNEW_DB;
$missCallTable = "tblcloudring_puriRath_vivek";
$missCallNumber = "8010896060";

// OTP settings
$smsProvider = 6;
$smsSenderId = "APILRY";
$smsTemplateId = "1707168622478525534";
...
// Log params
$logFileName = "log_ITC_PuriRath_Vivek";
...
if ($sMobile) {
    ...
    if ($iTotal < 1) {
        // Generate OTP
        $getUniqueCode = "";
        $message = "Hi, Welcome to Sunfeast YiPPee! Family. Let us all go YiPPee!- APPILARY";
        ...
        if ($isOtpSent) {
            ...
            $sIN_Query_Org = "INSERT INTO $dbName.$missCallTable (process, token, rec_who, rec_circle, rec_op, rec_misscallno" .
                ", api_output, rcd, rdt) VALUES ('0', '$getUniqueCode', '$sMobile', '$sCircle', '$sOperator', '$missCallNumber', '$sOutput', '$currentDate', '$currentDateTime')";
