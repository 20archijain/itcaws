...
// Log params
$logFileName = "log_Impact_BritanniaNutri";
...
if ($sMobile) {
    ...
    if ($iTotal < $maxCallsAllowedPerDay) {
        ...
        $message = "Thank you for participating in Britannia Marie Gold Campaign." .
            " Your Britannia Marie Gold code is $getUniqueCode. - APPILARY";
    } else {
        // Generate OTP
        $getUniqueCode = "";
        ...
        // Existing customer
        $message = "Thank you for participating in Britannia Marie Gold Campaign," .
            " you have already registered with us. - APPILARY";
    }
