...
// DB params
$dbName = $IMPACT_DB;
$missCallTable = "tblcloudring_Nauchandi_9015908182";
$missCallNumber = "9015908182";
...
// Log params
$logFileName = "log_Yippee_Nauchandi";
...
if ($sMobile) {
    ...
    // 1st Send SMS
    if ($iTotal == 0) {
        $message = "Sunfeast YiPPee! परिवार का हिस्सा बनने के लिए आपका धन्यवाद | - APPILARY";
    }
    if ($iTotal == 1) {
        // 2nd SMS
        $message = "Sunfeast YiPPee! परिवार का हिस्सा बनने के लिए आपका धन्यवाद | - APPILARY";
    ...
    if ($iTotal < 2) {
        ...
        if ($isOtpSent) {
            ...
            $sIN_Query = "INSERT INTO $dbName.$missCallTable (process, token, rec_who, rec_circle, rec_op, rec_misscallno" .
                ", api_output, rcd, rdt) VALUES " .
