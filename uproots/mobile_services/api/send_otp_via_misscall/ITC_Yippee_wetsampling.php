...
// DB params
$dbName = $ITCNEW_DB;
$missCallTable = "tblcloudring_live_yippee_wetsample";
...
// Log params
$logFileName = "log_ITC_Yippee_wetsampling";
...
if ($sMobile) {
    ...
    // If this value is less than $maxCallsAllowedPerDay, send OTP else don't send
