...
// DB params
$dbName = $ITCNEW_DB;
$missCallTable = "tblcloudring_live_durgapuja";
$missCallNumber = "9599372266";
...
// Log params
$logFileName = "log_itcnew_DurgaPuja";
...
if ($sMobile) {
    ...
    $message = "Candyman Fantastik welcomes you to the Chocolaty Tornado. Collect flags inside." .
        " *T&C applied - Appilary";
