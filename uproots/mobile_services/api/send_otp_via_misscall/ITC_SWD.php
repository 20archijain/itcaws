...
// DB params
$dbName = $ITCNEW_DB;
$missCallTable = "tblcloudring_YippeeSWD_8010896060";
...
if ($sMobile) {
    ...
    $message = "Welcome to Sunfeast YiPPee! Market Champion Contest." .
        " Please contact your ITC WD Salesman for details on how to participate - Appilary";
