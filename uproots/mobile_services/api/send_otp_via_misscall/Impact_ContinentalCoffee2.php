...
// DB params
$dbName = $IMPACT_DB;
$missCallTable = "tblcloudring_ITC_Sunfeast";
...
// Log params
$logFileName = "log_Impact_ContinentalCoffee2";
...
if ($sMobile) {
    ...
    if ($iTotal == 0) {
        ...
        // 2nd SMS
        $message = "Thank you for showing interest. You are already registred with us. - APPILARY";
    }
