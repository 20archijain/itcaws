...
// Log params
$logFileName = "log_itcnew_Svasti_milkInShopKol-hold";
...
if ($sMobile) {
    ...
    $message = "Thank you for showing interest in Svasti." .
        " Please share your coupon code $getUniqueCode with our promoter to avail the offer.";
