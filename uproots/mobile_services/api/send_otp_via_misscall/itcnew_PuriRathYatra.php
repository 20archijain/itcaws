...
// DB params
$dbName = $ITCNEW_DB;
$missCallTable = "tblcloudring_live_purirathyatra";
...
// Log params
$logFileName = "log_itcnew_PuriRathYatra";
...
if ($sMobile) {
    ...
    $message = "Thank you for connecting with ITC Aashirvaad Iodized Salt." .
        " Please collect your Nimbu Pani made with Goodness of Aashirvaad Salt - Appilary";
