...
// DB params
$dbName = $ITCNEW_DB;
$missCallTable = "tblcloudring_live_mkp4";
...
if ($sMobile) {
    ...
    $message = "ITC इ-चौपाल मनोरंजन का पिटारा में भाग लेने के लिए आपका धन्यवाद!" .
        " ITC परिवार में आपका स्वागत है! -Appilary";
