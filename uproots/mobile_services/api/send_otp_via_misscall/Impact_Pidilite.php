...
// Log params
$logFileName = "log_Impact_Pidilite";
$logFolderName = "/otp_via_misscall";
$sResponse = "";
...
if ($sMobile) {
    // Generate OTP
    $getUniqueCode = $otp->generateUniqueNumericCode(4, true, $dbName, $missCallTable);

    $message = "Your Pidilite unique OTP is $getUniqueCode." .
        " Share this OTP with SIY team to get your Amazon discount voucher.\n- Appilary";
    ...
    if ($isOtpSent) {
        ...
        $sIN_Query = "INSERT INTO $dbName.$missCallTable (process, token, rec_who, rec_circle, rec_op, rec_misscallno, api_output" .
            ", rcd, rdt) VALUES ('0', '$getUniqueCode', ?, ?, ?, ?, ?, '$currentDate', '$currentDateTime')";
        $arrParams = array(
